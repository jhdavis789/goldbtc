...
<p class="muted" style="color:#9fb4c2">Synthesized figures are reasoned judgments under each approach's logic, anchored to a scripted realized baseline — not computed forecasts. Source-published figures are cited where they exist. By JAOD &amp; (mainly) Claude.</p>
</header>
<div class="wrap">
